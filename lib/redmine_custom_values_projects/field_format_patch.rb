  ...
  module FieldFormatPatch
    def self.included(base)
      ...
      base.class_eval do
		...
		alias_method :possible_custom_value_options_without_custom_values_per_project, :possible_custom_value_options
		alias_method :possible_custom_value, :possible_custom_value_options_with_custom_values_per_project
		alias_method :possible_values_options_values_per_project, :possible_custom_value_options
